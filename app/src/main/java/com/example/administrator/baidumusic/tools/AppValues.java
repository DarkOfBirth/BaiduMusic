...
public final class AppValues {
    ...
    public static final String WELCOME_IMAGE_URL = "http://img1.gamedog.cn/2013/07/12/43-130G21509190.jpg";
    public static final String MUSIC_LIST = "http://tingapi.ting.baidu.com/v1/restserver/ting?from=android&version=5.9.0.0&channel=xiaomi&operator=0&method=baidu.ting.ugcdiy.getChanneldiy&param=k8HEX%2FMB%2BzEmeSCCXylP3IVvDrRb1qarKPk5dP8%2F8oUWsIPOQWuCewyZVU6ysFrPpeyM4N9%2BSRUFxTXivsvVuSxNVR4oXV7RQFGFYDUzM2x7IDDMRNV9Ip%2B2LY31aM8s&timestamp=1477490631&sign=05477a31c8e40741d13e7733b2d0e00a";
    public static final String TOP_LIST = "http://tingapi.ting.baidu.com/v1/restserver/ting?method=baidu.ting.billboard.billCategory&format=json&from=ios&version=5.2.1&from=ios&channel=appstore";
    public static final String VIDEO = "http://tingapi.ting.baidu.com/v1/restserver/ting?from=android&version=5.9.0.0&channel=xiaomi&operator=0&provider=11%2C12&method=baidu.ting.mv.searchMV&format=json&order=1&page" + "_num=1&page_size=20&query=%E5%85%A8%E9%83%A8";
    public static final String RECOMMEND = "http://tingapi.ting.baidu.com/v1/restserver/ting?from=android&version=5.9.0.0&channel=xiaomi&operator=0&method=baidu.ting.plaza.index&cuid=BB4CB967DAEF05B2F1B359FA3A90CA88";
    public static final String MUSIC_LIST_LAST = "http://tingapi.ting.baidu.com/v1/restserver/ting?from=android&version=5.9.0.0&channel=xiaomi&operator=0&method=baidu.ting.ugcdiy.getChanneldiy&param=kQr4Ajwx3qpKDoRbLTGWOwSe7SOYdQZiJrWR2GlQvPXxdYVwGSvpE8rERYmUzbsRDaciKgTlXBYl7c71wRsyilrU2hBZw5hja%2BU4BM7xYQFVqCF2ZykoOdIGqFkkuWBn&timestamp=1477490592&sign=de2f8026497500c3545d67002a147192";
    ...
    public static String VIDEO = "http://tingapi.ting.baidu.com/v1/restserver/ting?from=android&version=5.9.0.0&channel=xiaomi&operator=0&provider=11%2C12&method=baidu.ting.mv.searchMV&format=json&order=1&page" +
            "_num=1&page_size=20&query=%E5%85%A8%E9%83%A8";
    ...
    // TODO: 16/11/1
    // 接口
    // http://tingapi.ting.baidu.com/v1/restserver/ting?method=baidu.ting.diy.gedanInfo&from=ios&listid=参数&version=5.2.3&from=ios&channel=appstore"
